...
// POST /api/progress/complete — chamado quando o usuário resolve um desafio.
router.post('/progress/complete', requireAuth, async (req, res) => {
  ...
  // Evita passar do total mesmo se o front chamar essa rota mais vezes que o esperado.
